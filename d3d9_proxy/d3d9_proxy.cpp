...
static const wchar_t* kAs2ModVersion = L"0.6-beta";
...
void InitConsole() {
    ...
    if (AllocConsole()) {
        ...
        printf("\033[36m");
        printf("========================================\n");
        printf("  Alice Senki 2 - Improvement Mod 0.6-beta\n");
...
void RenderImGui() {
    ...
    if (g_showMenu && !exclusiveOverlay) {
        ...
        if (ImGui::BeginMainMenuBar()) {
            ImGui::Text("Alice Senki 2 - Improvement Mod 0.6-beta");
            ImGui::Separator();
...
BOOL APIENTRY DllMain(HMODULE hModule, DWORD reason, LPVOID lpReserved) {
    switch (reason) {
        case DLL_PROCESS_ATTACH: {
            ...
            ProxyLog("========================================");
            ProxyLog("Alice Senki 2 - D3D9 Proxy 0.6-beta");
